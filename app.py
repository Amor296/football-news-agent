...
with st.form("pro_subscription"):
    ...
    with col1:
        ...
        interest = st.selectbox("Target Entity", ["Real Madrid", "Premier League", "La Liga", "Al Ahly", "Zamalek", "Transfer Market"])
    with col2:
...
if submit_btn:
    if email and "@" in email:
        try:
            ...
            st.error(f"Cloud Connection Error: Make sure Secrets are set correctly and the Sheet is shared with your Service Account email.")
    else:
